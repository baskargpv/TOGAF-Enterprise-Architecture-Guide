...
```mermaid
flowchart LR
Strategy --> ArchitectureVision
ArchitectureVision --> ArchitectureRunway
ArchitectureRunway --> ProductBacklog
ProductBacklog --> SprintPlanning
SprintPlanning --> Delivery
Delivery --> Feedback
Feedback --> ArchitectureVision
```
...
```mermaid
flowchart TD
BusinessStrategy --> Roadmap
Roadmap --> Delivery
Delivery --> Learn
Learn --> ImproveArchitecture
ImproveArchitecture --> Roadmap
```
