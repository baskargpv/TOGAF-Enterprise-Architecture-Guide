...
Drivers --> Vision
Vision --> Objectives
Objectives --> TargetArchitecture
TargetArchitecture --> Projects
Projects --> BusinessValue
```
...
```mermaid
flowchart TD
Preliminary --> PhaseA["Phase A<br/>Architecture Vision"]
PhaseA --> BusinessArchitecture
