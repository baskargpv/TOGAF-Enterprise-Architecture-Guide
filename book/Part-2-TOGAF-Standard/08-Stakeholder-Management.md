...
```mermaid
flowchart TB
A[High Influence<br/>High Interest<br/>Manage Closely]
B[High Influence<br/>Low Interest<br/>Keep Satisfied]
C[Low Influence<br/>High Interest<br/>Keep Informed]
D[Low Influence<br/>Low Interest<br/>Monitor]
...
flowchart LR
Stakeholders --> Vision
Vision --> BusinessArchitecture
BusinessArchitecture --> InformationSystems
InformationSystems --> TechnologyArchitecture
TechnologyArchitecture --> Implementation
