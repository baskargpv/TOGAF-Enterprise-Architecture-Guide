...
```mermaid
flowchart LR
RequestForArchitectureWork --> Stakeholders
Stakeholders --> BusinessDrivers
BusinessDrivers --> Scope
Scope --> ArchitectureVision
ArchitectureVision --> BusinessCase
BusinessCase --> StatementOfArchitectureWork
StatementOfArchitectureWork --> PhaseB
```
...
```mermaid
flowchart TD
BusinessStrategy --> ArchitectureVision
ArchitectureVision --> BusinessArchitecture
