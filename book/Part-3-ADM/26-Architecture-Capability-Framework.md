...
```mermaid
flowchart TD
BusinessStrategy --> ArchitectureCapability
ArchitectureCapability --> Governance
ArchitectureCapability --> Processes
ArchitectureCapability --> People
ArchitectureCapability --> Tools
ArchitectureCapability --> Repository
ArchitectureCapability --> Standards
ArchitectureCapability --> Skills
```
