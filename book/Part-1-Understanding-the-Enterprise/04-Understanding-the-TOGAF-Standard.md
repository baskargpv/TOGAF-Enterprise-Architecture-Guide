...
flowchart TD
A[TOGAF Standard]
A --> B[Architecture Development Method]
A --> C[ADM Techniques]
A --> D[Content Framework]
A --> E[Enterprise Continuum]
A --> F[Architecture Repository]
A --> G[Reference Models]
A --> H[Architecture Capability]
A --> I[Governance]
A --> J[Architecture Principles]
```
...
Governance --> Projects
Projects --> BusinessValue[Business Value]
```
