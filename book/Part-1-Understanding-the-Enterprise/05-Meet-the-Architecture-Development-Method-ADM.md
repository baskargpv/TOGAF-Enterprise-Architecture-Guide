...
```mermaid
flowchart LR
P[Preliminary] --> A[Phase A<br/>Architecture Vision]
...
```mermaid
flowchart TD
BusinessStrategy --> ADM
ADM --> TargetArchitecture
TargetArchitecture --> Projects
Projects --> BusinessOutcomes
BusinessOutcomes --> ContinuousImprovement
ContinuousImprovement --> ADM
```
